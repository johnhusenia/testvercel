...
const BrowseList = () => {
    ...
    return (
        ...
        <h1 style={{ fontSize: '2rem', marginBottom: '20px', color: 'white' }}>Browse</h1>
            <Box sx={{ width: '100%' }}>
            ...
            {tabIndex === 1 && (
                <div>
                    <GenreList data={movies} category={"Multimedia"} />
                </div>
            )}
            {tabIndex === 0 && (
                <div>
                    <MovieDisplay data={movies} setContent={setMovies} category={"Multimedia"} />
                </div>
            )}
